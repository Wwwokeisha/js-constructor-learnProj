...
var text = 'Тут должно быть что-то интересное...';
...
}), new _blocks.ColumnsBlock(['Приложение на чистом JS, без использования библиотек', 'JavaScript - это просто, интересно. Научись создавать любые UI своими руками', 'Узнаешь как работают принципы SOLID и ООП в JS за один курс'], {
  styles: {
...
},{"./model":"model.js","./classes/app":"classes/app.js","./style/main.css":"style/main.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
